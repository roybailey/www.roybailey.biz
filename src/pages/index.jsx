    ...
    return (
      <div className="relative text-gray-800 bg-gray-50">
          <section className="px-10 mt-10">
              ...
              <div className="w-full h-full bg-gray-100 px-2 py-2">
                      ...
                      <div className="rounded overflow-hidden shadow-md bg-white">
                          <div className="flex flex-col items-center justify-center text-center h-screen-half">
                              <img
                                  ...
                                  alt="Roy Bailey"/>
                              <h1 className="text-5xl md:text-6xl lg:text-7xl">Roy Bailey</h1>
                              ...
                              <ul className="list-none text-center text-gray-600 text-base md:text-lg font-normal pt-3 px-3">
                                  <li>Head of Engineering</li>
                                  <li>Software Engineering Manager</li>
                                  <li>Running Remote Engineering Offices</li>
                                  <li><br /></li>
                              ...
                              <p className="text-center text-base px-3 pb-4 font-normal flex flex-col gap-2">
                                  <div className="text-sm md:text-base text-gray-400 italic font-sans">Available for fractal work through my company...</div>
